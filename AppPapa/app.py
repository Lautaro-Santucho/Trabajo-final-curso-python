...
class Interfaz:
    def __init__(self):
        ...
        self.convocatoria = SeleccionesBD.Selecc()
    ...
    def listarSelecc(self):
        ...
        for fila in self.convocatoria.listar():
    ...
    def agregarSelecc(self):
        ...
        self.convocatoria.agregar(datos)
        self.datoCodigo.set("")
        self.datoDNI.set("")
        self.datoNombre.set("")
    ...
    def borrarSelecc(self):
        ...
        self.convocatoria.borrar(datos)
        self.listarSelecc()

    def consultarSelecc(self):
        datos = (self.treeview.item(self.treeview.selection())["text"],)
        self.convocatoria.consultar(datos)
    ...
    def actualizarSelecc(self):
        ...
        self.convocatoria.actualizar(datos)
    ...
    def imprimirSelecc(self):
        lista = self.convocatoria.imprimir()
